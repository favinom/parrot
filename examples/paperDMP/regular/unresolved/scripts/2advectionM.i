...
# outputFileName = mesh_${mResName}${mRefLevName}${mUmr}.e
...
[Outputs]
 file_base = AdvectionOut_${mResName}${mRefLevName}${mUmr}
[./exodus]
 type = Exodus
 sync_only = true
 sync_times = '0.01 0.1 0.25 0.5'
 [../]
 csv = true
 perf_graph = true
 []
...
[./soln]
 ...
 fractureMeshModifier = fractureUserObject
# output_file=DiffusionOut2_${mResName}${mRefLevName}${mUmr}.e
 solver_type = 1
 conservative = false
 [../]
