...
Flux1LineAName='./Flux1_line_A'+case+'.csv'
Flux2LineAName='./Flux2_line_A'+case+'.csv'
...
SaveData(Flux1LineAName, proxy=plotOverLine1, Precision=12, WriteTimeSteps=0)

reader.PointVariables = ['flux_2']
SaveData(Flux2LineAName, proxy=plotOverLine1, Precision=12, WriteTimeSteps=0)
