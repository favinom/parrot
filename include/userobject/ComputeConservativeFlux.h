...
class ComputeConservativeFlux;

template <>
InputParameters validParams<ComputeConservativeFlux>();
...
class ComputeConservativeFlux : public GeneralUserObject
{

    
    
public:
  ComputeConservativeFlux(const InputParameters & params);
  ...
  protected:
    ...
    PetscMatrix<Number> _stiff_matrix;

    void AssembleDiffusionOP(PetscVector<Number> &_rhs);
