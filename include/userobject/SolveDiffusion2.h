...
class SolveDiffusion2;

template <>
InputParameters validParams<SolveDiffusion2>();
...
class SolveDiffusion2 : public GeneralUserObject
{

    
    
public:
  SolveDiffusion2(const InputParameters & params);
