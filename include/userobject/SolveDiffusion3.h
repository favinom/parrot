...
class SolveDiffusion3;

template <>
InputParameters validParams<SolveDiffusion3>();
...
class SolveDiffusion3 : public GeneralUserObject
{

    
    
public:
  SolveDiffusion3(const InputParameters & params);
